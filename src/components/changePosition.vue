<template>
  <div class="change-position father">
    <div class="content"
         v-loading="loading"
          ...
          <div class="pub-form">
            <el-form inline label-position="top" ref="pubform" :model="pubform">
                  ...
                  <el-row :gutter="40">
                    <el-col :span="12">
                      <el-form-item prop="position_industry"
                                    :rules="{type:'number',required: true, message: '请选择行业分类', trigger: 'blur'}">
                        <el-select placeholder="行业" v-model.number="pubform.position_industry">
                    ...
                    <el-col :span="12">
                      <el-form-item prop="position_function"
                                    :rules="{type:'number',required: true, message: '请选择业务分类', trigger: 'blur'}">
                        <el-select placeholder="业务" v-model.number="pubform.position_function">
              ...
              <el-row :gutter="40">
                ...
                <el-col :span="12">
                  <el-form-item prop="position_type"
                                :rules="{type:'number',required: true, message: '请选择岗位分类', trigger: 'blur'}">
                    <el-select placeholder="岗位分类" v-model.number="pubform.position_type">
              ...
              <el-row :gutter="40">
                <el-col :span="12">
                  <el-form-item prop="position_graduation_year"
                    ...
                    <el-select placeholder="工作年限" v-model.number="pubform.position_graduation_year"
                               v-if="pubform.position_type == '3'"
                               :rules="{type:'number',required: true, message: '请选择时间', trigger: 'blur'}">
                  ...
                  <el-row :gutter="40">
                    <el-col :span="12">
                      <el-form-item prop="position_regular"
                                    :rules="{type:'number',required: true, message: '请选择是否留用', trigger: 'blur'}">
                        <el-select placeholder="留用机会" v-model.number="pubform.position_regular">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      submitPubPos() {
        //删除无用字段
        delete this.pubform.collert_num;
        delete this.pubform.create_time;
        delete this.pubform.deleted;
        delete this.pubform.update_time;
        delete this.pubform.user_id;
        delete this.pubform.username;
    ...
    created: function () {
      ...
      this.axios({
        ...
        if (res.data.code === '0') {
          this.pubform = res.data.data.rpDTO[0];
          let d = new Date(this.pubform.position_validity);
          this.pubform.position_validity = d;
          this.loading = false;
        }
      })
    }
